...
def pad_sequences(data, max_length):
    ...
    Example: for the (sentence, labels) pair: [[4,1], [6,0], [7,0]], [1, 0, 0], and max_length = 5, we would construct
    ...
    for sentence, labels in data:
        ...
        slen = min(len(sentence), max_length)
        plen = max_length - slen

        padded_sentence = sentence[:slen] + [zero_vector] * plen
        padded_labels = labels[:slen] + [zero_label] * plen
