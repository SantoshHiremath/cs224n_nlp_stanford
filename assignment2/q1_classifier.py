...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        self.input_placeholder = tf.placeholder(shape=(batch_size, n_features), dtype=tf.float32)
        self.labels_placeholder = tf.placeholder(shape=(batch_size, n_classes), dtype=tf.int32)        
        ### END YOUR CODE
	...
	W = tf.get_variable("W", [n_features, n_classes], initializer = tf.zeros_initializer())
	b = tf.get_variable("b", [n_classes], initializer = tf.zeros_initializer())
